package com.breezevasista.features.addshop.presentation
...
import com.breezevasista.features.dashboard.presentation.ShopVerificationDialog
import com.breezevasista.features.dashboard.presentation.VisitRemarksTypeAdapter
...
import com.breezevasista.features.location.model.ShopDurationRequestData
...
import com.breezevasista.features.viewAllOrder.interf.QaOnCLick
        ...
        when (p0!!.id) {
            et_recordAudioNw.id,iv_recordAudioNw.id ->{
                try {
                    ...
                    filePathNewAudio = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/recorded_audio${System.currentTimeMillis()}.wav"
