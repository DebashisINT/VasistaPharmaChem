package com.breezevasista.features.dashboard.presentation
...
import com.breezevasista.*
import com.breezevasista.R
import com.breezevasista.app.*
import com.breezevasista.app.NewFileUtils.browseDocuments
import com.breezevasista.app.NewFileUtils.browsePDFDocuments
import com.breezevasista.app.NewFileUtils.getExtension
import com.breezevasista.app.domain.*
import com.breezevasista.app.types.DashboardType
import com.breezevasista.app.types.FragType
import com.breezevasista.app.types.TopBarConfig
import com.breezevasista.app.uiaction.DisplayAlert
import com.breezevasista.app.utils.*
import com.breezevasista.app.utils.AppUtils.Companion.isProfile
...
import com.breezevasista.features.NewQuotation.*
import com.breezevasista.features.NewQuotation.api.GetQuotRegProvider
import com.breezevasista.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezevasista.features.SearchLocation.SearchLocationFragment
import com.breezevasista.features.SearchLocation.locationInfoModel
import com.breezevasista.features.TA.ViewAllTAListFragment
import com.breezevasista.features.achievement.AchievementFragment
import com.breezevasista.features.activities.presentation.*
import com.breezevasista.features.addAttendence.*
import com.breezevasista.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezevasista.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezevasista.features.addAttendence.model.GetReportToFCMResponse
import com.breezevasista.features.addAttendence.model.GetReportToResponse
import com.breezevasista.features.addAttendence.model.Leave_list_Response
import com.breezevasista.features.addorder.presentation.AddOrderFragment
...
import com.breezevasista.features.addshop.presentation.AddShopFragment
import com.breezevasista.features.addshop.presentation.OTPVerificationDialog
import com.breezevasista.features.addshop.presentation.ScanImageFragment
import com.breezevasista.features.addshop.presentation.ShowCardDetailsDialog
import com.breezevasista.features.alarm.model.AlarmData
import com.breezevasista.features.alarm.presetation.AttendanceReportFragment
import com.breezevasista.features.alarm.presetation.PerformanceReportFragment
import com.breezevasista.features.alarm.presetation.VisitReportDetailsFragment
import com.breezevasista.features.alarm.presetation.VisitReportFragment
import com.breezevasista.features.attendance.AttendanceFragment
import com.breezevasista.features.attendance.api.AttendanceRepositoryProvider
import com.breezevasista.features.attendance.model.AttendanceRequest
import com.breezevasista.features.attendance.model.AttendanceResponse
import com.breezevasista.features.averageshop.presentation.AverageShopFragment
import com.breezevasista.features.avgorder.presentation.AverageOrderFragment
import com.breezevasista.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezevasista.features.beatCustom.TeamBeatListFragment
import com.breezevasista.features.billing.presentation.AddBillingFragment
import com.breezevasista.features.billing.presentation.BillingDetailsFragment
import com.breezevasista.features.billing.presentation.BillingListFragment
import com.breezevasista.features.changepassword.presentation.ChangePasswordDialog
import com.breezevasista.features.chat.model.ChatListDataModel
import com.breezevasista.features.chat.model.ChatUserDataModel
import com.breezevasista.features.chat.model.GroupUserDataModel
import com.breezevasista.features.chat.presentation.*
import com.breezevasista.features.chatbot.presentation.ChatBotFragment
import com.breezevasista.features.chatbot.presentation.ChatBotShopListFragment
import com.breezevasista.features.chatbot.presentation.ReportsFragment
import com.breezevasista.features.chatbot.presentation.SelectLanguageDialog
import com.breezevasista.features.commondialog.presentation.CommonDialog
import com.breezevasista.features.commondialog.presentation.CommonDialogClickListener
import com.breezevasista.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezevasista.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezevasista.features.commondialogsinglebtn.OnDialogClickListener
import com.breezevasista.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezevasista.features.contacts.ActivityDtlsFrag
import com.breezevasista.features.contacts.AddOpptFrag
import com.breezevasista.features.contacts.ContactDtls
import com.breezevasista.features.contacts.ContactGr
import com.breezevasista.features.contacts.ContactsAddFrag
import com.breezevasista.features.contacts.ContactsFrag
import com.breezevasista.features.contacts.SchedulerAddFormFrag
import com.breezevasista.features.contacts.SchedulerViewFrag
import com.breezevasista.features.contacts.TemplateAddFrag
import com.breezevasista.features.contacts.TemplateViewFrag
import com.breezevasista.features.contacts.ViewCrmOpptFrag
import com.breezevasista.features.dailyPlan.prsentation.AllShopListFragment
import com.breezevasista.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezevasista.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezevasista.features.damageProduct.ShopDamageProductListFrag
import com.breezevasista.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezevasista.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezevasista.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezevasista.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezevasista.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezevasista.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezevasista.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezevasista.features.dashboard.presentation.model.ContentListResponseModel
import com.breezevasista.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezevasista.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezevasista.features.device_info.presentation.DeviceInfoListFragment
import com.breezevasista.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezevasista.features.document.DocumentRepoFeatureNewFragment
import com.breezevasista.features.document.presentation.DocumentListFragment
import com.breezevasista.features.document.presentation.DocumentTypeListFragment
import com.breezevasista.features.document.presentation.OpenFileWebViewFragment
import com.breezevasista.features.dymanicSection.presentation.AddDynamicFragment
import com.breezevasista.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezevasista.features.dymanicSection.presentation.DynamicListFragment
import com.breezevasista.features.dymanicSection.presentation.EditDynamicFragment
import com.breezevasista.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezevasista.features.home.presentation.HomeFragment
import com.breezevasista.features.homelocation.presentation.HomeLocationFragment
import com.breezevasista.features.homelocation.presentation.HomeLocationMapFragment
import com.breezevasista.features.know_your_state.KnowYourStateFragment
import com.breezevasista.features.lead.LeadFrag
import com.breezevasista.features.lead.ViewLeadFrag
import com.breezevasista.features.leaderboard.LeaderBoardFrag
import com.breezevasista.features.leaveapplynew.LeaveHome
import com.breezevasista.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezevasista.features.localshops.LocalShopListFragment
import com.breezevasista.features.localshops.LocalShopListMapFragment
import com.breezevasista.features.localshops.NearByShopsMapFragment
import com.breezevasista.features.location.*
import com.breezevasista.features.location.api.LocationRepoProvider
import com.breezevasista.features.location.model.*
import com.breezevasista.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezevasista.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezevasista.features.login.ShopFeedbackEntity
import com.breezevasista.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezevasista.features.login.presentation.LoginActivity
import com.breezevasista.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezevasista.features.logoutsync.presentation.LogoutSyncFragment
import com.breezevasista.features.marketAssist.MarketAssistTabFrag
import com.breezevasista.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezevasista.features.marketAssist.ShopListMarketAssistFrag
import com.breezevasista.features.marketing.presentation.MarketingPagerFragment
import com.breezevasista.features.meetinglist.prsentation.MeetingListFragment
import com.breezevasista.features.member.MapViewForTeamFrag
import com.breezevasista.features.member.model.TeamLocDataModel
import com.breezevasista.features.member.model.TeamShopListDataModel
import com.breezevasista.features.member.presentation.*
import com.breezevasista.features.menuBeat.MenuBeatFrag
import com.breezevasista.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezevasista.features.micro_learning.presentation.MicroLearningListFragment
import com.breezevasista.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezevasista.features.myallowancerequest.MyallowanceRequestFragment
import com.breezevasista.features.myjobs.model.CustomerDataModel
import com.breezevasista.features.myjobs.presentation.*
import com.breezevasista.features.mylearning.MyLearningFragment
import com.breezevasista.features.myorder.presentation.MyOrderListFragment
import com.breezevasista.features.myprofile.presentation.MyProfileFragment
import com.breezevasista.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezevasista.features.nearbyshops.model.ShopData
import com.breezevasista.features.nearbyshops.model.ShopListResponse
import com.breezevasista.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezevasista.features.nearbyshops.presentation.BeatListFragment
import com.breezevasista.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezevasista.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezevasista.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezevasista.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezevasista.features.newcollection.CollectionDetailsStatusFragment
import com.breezevasista.features.newcollection.CollectionShopListFragment
import com.breezevasista.features.newcollection.NewCollectionListFragment
import com.breezevasista.features.newcollectionreport.*
import com.breezevasista.features.notification.NotificationFragment
import com.breezevasista.features.orderITC.CartListFrag
import com.breezevasista.features.orderITC.OrderListFrag
import com.breezevasista.features.orderITC.ProductListFrag
import com.breezevasista.features.orderITC.ViewNewOrdHisAllFrag
import com.breezevasista.features.orderITC.ViewNewOrdHistoryFrag
import com.breezevasista.features.orderITC.ViewOrdDtls
import com.breezevasista.features.orderList.NewDateWiseOrderListFragment
import com.breezevasista.features.orderList.NewOrderListFragment
import com.breezevasista.features.orderList.OrderListFragment
import com.breezevasista.features.orderdetail.presentation.OrderDetailFragment
import com.breezevasista.features.orderhistory.ActivityMapFragment
import com.breezevasista.features.orderhistory.OrderhistoryFragment
import com.breezevasista.features.orderhistory.TimeLineFragment
import com.breezevasista.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezevasista.features.orderhistory.model.LocationData
import com.breezevasista.features.pendinglocationinout.PendingOutLocationFrag
import com.breezevasista.features.performance.GpsStatusFragment
import com.breezevasista.features.performance.PerformanceFragment
import com.breezevasista.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezevasista.features.performance.model.UpdateGpsInputParamsModel
import com.breezevasista.features.performanceAPP.OwnPerformanceFragment
import com.breezevasista.features.performanceAPP.PerformanceAppFragment
import com.breezevasista.features.performanceAPP.allPerformanceFrag
import com.breezevasista.features.permissionList.ViewPermissionFragment
import com.breezevasista.features.photoReg.*
import com.breezevasista.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezevasista.features.quotation.presentation.*
import com.breezevasista.features.reimbursement.presentation.*
import com.breezevasista.features.report.presentation.*
import com.breezevasista.features.returnsOrder.*
import com.breezevasista.features.settings.presentation.SettingsFragment
import com.breezevasista.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezevasista.features.shopdetail.presentation.*
import com.breezevasista.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezevasista.features.stock.StockDetailsFragment
import com.breezevasista.features.stock.StockListFragment
import com.breezevasista.features.stockAddCurrentStock.AddShopStockFragment
import com.breezevasista.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezevasista.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezevasista.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezevasista.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezevasista.features.stockCompetetorStock.CompetetorStockFragment
import com.breezevasista.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezevasista.features.survey.SurveyFrag
import com.breezevasista.features.survey.SurveyViewDtlsFrag
import com.breezevasista.features.survey.SurveyViewFrag
import com.breezevasista.features.task.presentation.AddTaskFragment
import com.breezevasista.features.task.presentation.CalenderTaskFragment
import com.breezevasista.features.task.presentation.EditTaskFragment
import com.breezevasista.features.task.presentation.TaskListFragment
import com.breezevasista.features.taskManagement.TaskManagementFrag
import com.breezevasista.features.taskManagement.ViewTaskManagementFrag
import com.breezevasista.features.timesheet.presentation.AddTimeSheetFragment
import com.breezevasista.features.timesheet.presentation.EditTimeSheetFragment
import com.breezevasista.features.timesheet.presentation.TimeSheetListFragment
import com.breezevasista.features.viewAllOrder.CartFragment
import com.breezevasista.features.viewAllOrder.OrderTypeListFragment
import com.breezevasista.features.viewAllOrder.ViewAllOrderListFragment
import com.breezevasista.features.viewAllOrder.ViewCartFragment
import com.breezevasista.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezevasista.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezevasista.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezevasista.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezevasista.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezevasista.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezevasista.features.viewPPDDStock.ViewOutstandingFragment
import com.breezevasista.features.viewPPDDStock.ViewPPDDListFragment
import com.breezevasista.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezevasista.features.viewPPDDStock.ViewStockFragment
import com.breezevasista.features.weather.presentation.WeatherFragment
import com.breezevasista.mappackage.MapActivity
import com.breezevasista.mappackage.MapActivityWithoutPath
import com.breezevasista.mappackage.SendBrod
import com.breezevasista.widgets.AppCustomEditText
...
import com.breezevasista.features.mylearning.KnowledgeHubAllVideoList
import com.breezevasista.features.mylearning.LeaderboardLmsFrag
import com.breezevasista.features.mylearning.LmsQuestionAnswerSet
import com.breezevasista.features.mylearning.MyLearningAllVideoList
import com.breezevasista.features.mylearning.MyLearningVideoPlay
import com.breezevasista.features.mylearning.MyPerformanceFrag
import com.breezevasista.features.mylearning.NotificationLMSFragment
import com.breezevasista.features.mylearning.SearchLmsFrag
import com.breezevasista.features.mylearning.SearchLmsKnowledgeFrag
import com.breezevasista.features.mylearning.SearchLmsLearningFrag
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezevasistalogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezevasista/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
...
//                                tempDuration = duration
    ...
    private fun trackLMSModuleLoad(mFragType: FragType){
        try {
            var lmsL = AppDatabase.getDBInstance()!!.lmsUserInfoDao().getAllByDate(AppUtils.getCurrentDateyymmdd()) as ArrayList<LmsUserInfoEntity>
            var lmsModuleObj = LmsUserInfoEntity()

            if(mFragType.name.equals("SearchLmsFrag")){
                lmsModuleObj.module_name = "SearchLmsFrag"
            }else if(mFragType.name.equals("VideoPlayLMS")){
                lmsModuleObj.module_name = "VideoPlayLMS"
            }else if(mFragType.name.equals("LeaderboardLmsFrag")){
                lmsModuleObj.module_name = "LeaderboardLmsFrag"
            }else if(mFragType.name.equals("SearchLmsLearningFrag")){
                lmsModuleObj.module_name = "SearchLmsLearningFrag"
            }else if(mFragType.name.equals("SearchLmsKnowledgeFrag")){
                lmsModuleObj.module_name = "SearchLmsKnowledgeFrag"
            }else if(mFragType.name.equals("MyLearningAllVideoList")){
                lmsModuleObj.module_name = "MyLearningAllVideoList"
            }else if(mFragType.name.equals("KnowledgeHubAllVideoList")){
                lmsModuleObj.module_name = "KnowledgeHubAllVideoList"
            }else if(mFragType.name.equals("MyPerformanceFrag")){
                lmsModuleObj.module_name = "MyPerformanceFrag"
            }else if(mFragType.name.equals("NotificationLMSFragment")){
                lmsModuleObj.module_name = "NotificationLMSFragment"
            }else if(mFragType.name.equals("LmsQuestionAnswerSet")){
                lmsModuleObj.module_name = "LmsQuestionAnswerSet"
            }else if(mFragType.name.equals("MyLearningVideoPlay")){
                lmsModuleObj.module_name = "MyLearningVideoPlay"
            }

            println("tag_module_check ${lmsModuleObj.module_name}")
            if(!lmsModuleObj.module_name.equals("")){
                if(lmsL.size>0){
                    var lastFilterData = AppDatabase.getDBInstance()!!.lmsUserInfoDao().getByNameDate(AppUtils.getCurrentDateyymmdd(),lmsModuleObj.module_name).last()
                    //lmsModuleObj.count_of_use = (lastFilterData.count_of_use.toInt()+1).toString()
                    if(lastFilterData.module_name.equals(lmsModuleObj.module_name)){
