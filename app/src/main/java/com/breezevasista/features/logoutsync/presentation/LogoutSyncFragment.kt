package com.breezevasista.features.logoutsync.presentation
...
import com.breezevasista.CustomConstants
...
import com.breezevasista.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezevasista.features.billing.api.AddBillingRepoProvider
import com.breezevasista.features.billing.model.AddBillingInputParamsModel
...
import com.breezevasista.features.dashboard.presentation.ReasonDialog
...
import com.breezevasista.features.document.model.AddEditDocumentInputParams
import com.breezevasista.features.document.model.DocumentAttachmentModel
...
import com.breezevasista.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezevasista.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezevasista.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezevasista.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezevasista.features.orderhistory.model.*
...
import com.breezevasista.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezevasista.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezevasista.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezevasista.features.timesheet.model.AddTimeSheetInputModel
import com.breezevasista.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezevasista.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezevasista.features.viewAllOrder.model.AddOrderInputProductList
import com.breezevasista.mappackage.SendBrod
import com.breezevasista.widgets.AppCustomTextView
import com.breezevasista.MonitorService
import com.breezevasista.MySingleton
import com.breezevasista.app.AlarmReceiver
...
import com.breezevasista.features.addshop.presentation.ShopExtraContactReq
...
import com.breezevasista.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezevasista.features.login.model.GetConcurrentUserResponse
import com.breezevasista.features.login.model.WhatsappApiData
import com.breezevasista.features.orderITC.SyncDeleteOppt
import com.breezevasista.features.orderITC.SyncDeleteOpptL
import com.breezevasista.features.orderITC.SyncEditOppt
import com.breezevasista.features.orderITC.SyncOppt
import com.breezevasista.features.orderITC.SyncOpptProductL
import com.breezevasista.features.orderITC.SyncOrd
import com.breezevasista.features.orderITC.SyncOrdProductL
import com.breezevasista.features.performance.model.Gps_status_list
import com.breezevasista.features.performance.model.UpdateGpsInputListParamsModel
import com.breezevasista.features.returnsOrder.ReturnProductList
import com.breezevasista.features.returnsOrder.ReturnRequest
import com.breezevasista.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezevasistalogsample/log.zip").path);
