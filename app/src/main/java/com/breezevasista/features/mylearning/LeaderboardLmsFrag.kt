...
import com.breezevasista.features.leaderboard.AdapterSubBranchName
import com.breezevasista.features.leaderboard.LeaderBoardFilterOnDurationData
...
class LeaderboardLmsFrag : BaseFragment(), View.OnClickListener {
    ...
    private fun showPopup(view: View) {
            ...
            popup_message.setText("You need only 310 score to reach 1st position")
